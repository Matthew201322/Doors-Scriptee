...
local assets = {
    Repentance = LoadCustomInstance("https://raw.githubusercontent.com/Matthew201322/Doors-Scriptee/main/Repentance.rbxm"),
    Crucifix = LoadCustomInstance("https://raw.githubusercontent.com/Matthew201322/Doors-Scriptee/main/Crucifix.rbxm")
}
local moduleScripts = {
